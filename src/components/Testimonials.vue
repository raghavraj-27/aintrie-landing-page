<template>
  <section id="testimonials" class="pb-8">
    <v-container fluid>
      <v-row align="center" justify="center">
        <v-col cols="10">
          <v-card style="width: 100%">
            <h1 class="text-center pt-6 font-weight-light display-2">Testimonials</h1>
                ...
                <div class="flex-center">
                  <v-card-text>
                    <div class="flex-center">
                      <div class="circle1">
                        <div class="circle2">
                          <v-img src="~@/assets/img/maleProfile.png"></v-img>
                        </div>
                      </div>
                    </div>
                    <div class="text--disabled text-uppercase text-h5 my-2">Tanmay</div>
                    <v-divider class="my-2"/>
                    <div class=" grey--text">"Using this app for a long time and it manages all enquires of my coaching so well so that none enquiry is kept waiting."</div>
                    <!-- <v-divider class="my-2"/> -->
                ...
                <div class="flex-center">
                  <v-card-text>
                    <div class="flex-center">
                      <div class="circle1">
                        <div class="circle2">
                          <v-img src="~@/assets/img/maleProfile.png"/>
                        </div>
                      </div>
                    </div>
                    <div class="text--disabled text-uppercase text-h5 my-2">Vishal</div>
                    <v-divider class="my-2"/>
                    <div class="grey--text">"Web site creation from this app is very user friendly. Now I don't need to hire any developer for this task."</div>
                    <!-- <v-divider class="my-2"/> -->
                ...
                <div class="flex-center">
                  <v-card-text>
                    <div class="flex-center">
                      <div class="circle1">
                        <div class="circle2">
                          <v-img src="~@/assets/img/femaleProfile.png"/>
                        </div>
                      </div>
                    </div>
                    <div class="text--disabled text-uppercase text-h5 my-2">Swati</div>
                    <v-divider class="my-2"/>
                    <div class="grey--text">"Giving all the business benefits in such a small amount is awesome. I am saving a lot of money by using this app."</div>
                    <!-- <v-divider class="my-2"/> -->
