<template>
  <div>
    ...
    >
      <v-toolbar-title>
        <v-img src="@/assets/img/AintrieLogo.png" max-width="50px" />
      </v-toolbar-title>
      <v-spacer />
      <v-app-bar-nav-icon
      ...
      <div v-else>
        ...
        <v-btn text @click="$vuetify.goTo('#testimonials')">
...
export default {
  data: () => ({
    ...
    items: [
      ...
      ["mdi-currency-usd", "Preços", "#testimonials"],
